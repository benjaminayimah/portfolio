export default {
    state: {
        ...
        projects: [
            { id: 1, color: '#566FF4', type: 'project', title: 'Flexsale', thumbnail: require('@/assets/images/flexsale.png'), banner: require('@/assets/images/flexsale-banner.png'), banner_2: '', description: 'A multi-platform point of sale and inventory management system.',
            ...
            { id: 2, color: '#E03BB1', type: 'case study', title: 'Infinity Movies', thumbnail: require('@/assets/images/project-2-thumbnail.png'), banner: require('@/assets/images/project-2-banner.png'), banner_2: '', description: 'Movie trailer app for booking upcoming shows and streaming on-demand. ',
            ...
            { id: 3, color: '#95B1ED', type: 'case study', title: 'Phoenix Career Mentorship App', thumbnail: require('@/assets/images/project-3-thumbnail.png'), banner: require('@/assets/images/project-3-banner.png'), banner_2: '', description: 'Designing for social good: An app to help formarly incarcerated individuals to find jobs.',
                overview: { problem: 'd', product: 'Flexsale is a multi-platform inventory and point of sale application that provide retail store owners a flexible way to manage their store inventory, record sales, perform sales analysis, get notified of expiring products.', goal: '', role: '', duration: ''},
                empathize: { overview: '', pain_points: [ { id: 1, title: 'Lorem', description: 'Lorem ipsum'} ], person_name: '', problem_statement: '', persona_img: '', age: '', education: '', hometown: '', family: '', ocupation: '', headline: '', goals: [], frustrations: [], scenario: '', competitive_audit: '', audit_img: '', ideation: '', ideation_img: '', user_journey_map: '', user_journey_map_img: ''},
                starting_the_design: { site_map: '', site_map_img: '', paper_wireframe: '', paper_wireframe_img: '', digital_wireframe: '', digital_wireframe_img: '', screen_variations: '', screen_variations_imgs: [], lofi_prototyp: '', lofi_prototype_img: '', usability_study: '', usability_study_fidings: [] },
                refining_the_design: { mockups: '', accessibility_considerations: [], refined_designs: [], screen_variations: '', screen_variations_imgs: [], hifi_prototype: '', hifi_prototype_video: ''},
            ...
            { id: 4, color: '#51D6D6', type: 'case study', title: 'Pixels Tutorials App', thumbnail: require('@/assets/images/project-4-thumbnail.png'), banner: require('@/assets/images/project-4-banner.png'), banner_2: '', description: 'An app to help users find design tutorials and learn new skills.',
                overview: { problem: 'd', product: 'Flexsale is a multi-platform inventory and point of sale application that provide retail store owners a flexible way to manage their store inventory, record sales, perform sales analysis, get notified of expiring products.', goal: '', role: '', duration: ''},
                empathize: { overview: '', pain_points: [ { id: 1, title: 'Lorem', description: 'Lorem ipsum'} ], person_name: '', problem_statement: '', persona_img: '', age: '', education: '', hometown: '', family: '', ocupation: '', headline: '', goals: [], frustrations: [], scenario: '', competitive_audit: '', audit_img: '', ideation: '', ideation_img: '', user_journey_map: '', user_journey_map_img: ''},
                starting_the_design: { site_map: '', site_map_img: '', paper_wireframe: '', paper_wireframe_img: '', digital_wireframe: '', digital_wireframe_img: '', screen_variations: '', screen_variations_imgs: [], lofi_prototyp: '', lofi_prototype_img: '', usability_study: '', usability_study_fidings: [] },
                refining_the_design: { mockups: '', accessibility_considerations: [], refined_designs: [], screen_variations: '', screen_variations_imgs: [], hifi_prototype: '', hifi_prototype_video: ''},
