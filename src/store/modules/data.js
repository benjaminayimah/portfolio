export default {
    state: {
        ...
        projects: [
            { id: 1, type: 'project', title: 'Flexsale', image: require('@/assets/images/behance_shots.jpg'), description: 'A multi-platform point of sale and inventory management system.',
